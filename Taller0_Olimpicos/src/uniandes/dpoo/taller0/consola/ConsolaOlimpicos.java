...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				{
					System.out.println("Buscando pais del atleta...");
					paisDelAtleta();
				}
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Pais de un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	private void paisDelAtleta()
	{ 
		String atleta = input("Ingrese el nombre del atleta");
		String pais = calculadora.paisDelAtleta(atleta);
		System.out.println("El pais del atleta ingresado es " + pais);
	}
